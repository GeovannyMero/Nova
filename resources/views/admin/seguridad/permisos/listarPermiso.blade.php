				...
				<div class="tocify-content">
					<div class="icon-collection">
						<div class="fontawesome-icon-list">
							<a href="{{url('/crearPermiso')}}"><div class="fa-hover"><div class="icon-str"><i class="fa fa-plus"></i> <span>Agregar Permiso</span></div></div></a>
						</div>
					</div>
				</div>
			</div>
		...
		<tbody>
				@foreach($permiso as $i)
					...
					<tr>
						...
						<td>
							<a href="{{ url('permisos/edit',$i->id) }}"><button class="btn btn-secondary"><i class="fa fa-pencil"></i></button></a>
