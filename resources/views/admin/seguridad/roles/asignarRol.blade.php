...
<div class="page-title">
	...
	<div class="title-env">
			...
			<h1 class="title">Asignar Rol a Usuario</h1>
...
@include('alerts')
		<div class="panel panel-default">
			<div class="panel-heading">
					...
					<h3 class="panel-title">Asignar Rol</h3>
			...
			<div class="panel-body">
				...
				<div class="form-group">
	              ...
	              <a  class="btn btn-primary btn-single" href="{{ url('/clientes') }}"><i class="fa-chevron-left"></i></a>-->
	                  ...
	                  <a href="javascript:;" onclick="asignarRol()"><button class="btn btn-secondary">Guardar</button></a>
	                </div>
			</div>
		</div>
...
function asignarRol(){
	 ...
	 bootbox.confirm("Est&aacute; seguro que desea asignarle un <strong>Rol</strong> al <strong>Usuario?</strong>",function(result){

	 	if(result){
	 		var obtener = $("#frmDatos").serialize();
	 		route = "{{ url('/asignarRol/store') }}";
			RolU = "{{ url('/asignarRol')}}";
	 		$.ajax({
	 			type: 'POST',
	 			url: route,
	 			...
	 			success: function (data){
	 				 window.location = (RolU);

	 			},
	 			error: function(data){
	 				console.log('Error' + data);
	 				alertify.error('<strong>ERROR:</strong> No se ha asignado <strong>Rol</strong> al <strong>Usuario</strong>');
	 			}
	 		})
	 	}
	 });
