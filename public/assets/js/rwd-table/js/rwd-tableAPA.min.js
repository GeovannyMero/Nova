...
!function(a){
	...
	var e=function(b,c){
		...
		a(window).bind("orientationchange resize "+this.displayAllTrigger,
			function(){
		...
		e.DEFAULTS={
			...
			e.prototype.createButtonToolbar=function(){
				...
				this.$dropdownBtn=a('<button class="btn btn-default dropdown-toggle" data-toggle="dropdown">Mostrar <span class="caret"></span></button>'),
				...
				this.options.addDisplayAllBtn&&(this.$displayAllBtn=a('<button class="btn btn-default">Display all</button>'),
					...
					this.$displayAllBtn.click(function(){a.proxy(b.displayAll(null,!0),b)})),
				...
				e.prototype.clearAllFocus=function(){
					...
					e.prototype.activateFocus=function(){
						this.clearAllFocus(),this.$focusBtn&&this.$focusBtn.toggleClass("btn-primary"),
						this.$table.toggleClass("focus-on")},
						e.prototype.focusOnRow=function(b){
							if(this.$table.hasClass("focus-on")){
								var c=a(b).hasClass("focused");this.clearAllFocus(),c||(
								...
								e.prototype.displayAll=function(b,c){
									...
									e.prototype.preserveDisplayAll=function(){
										var b="table-cell";a("html").hasClass("lt-ie9")&&(b="inline"),
										...
										,e.prototype.createStickyTableHeader=function(){
											...
											b.$tableClone.find("[id]").each(function(){a(this).prop("id",a(this).prop("id")+"-clone")}),
										...
										e.prototype.updateStickyTableHeader=function(){
											...
											if(h){
												if(b.$stickyTableHeader.scrollLeft(b.$tableScrollWrapper.scrollLeft()),b.$stickyTableHeader.addClass("fixed-solution"),c=i-1,e-d>f?(c-=e-d-f,b.$stickyTableHeader.addClass("border-radius-fix")):b.$stickyTableHeader.removeClass("border-radius-fix"),k)
												...
												0>c?c=0:c>f&&(c=f),
												g>0&&(c-=g),
												k?(b.$stickyTableHeader.css({visibility:"visible"}),
													b.$stickyTableHeader.animate({top:c+"px"},l),
													b.$thead.css({visibility:"hidden"})):b.$stickyTableHeader.animate({top:"0"},l,function(){
														b.$thead.css({visibility:"visible"}),
														b.$stickyTableHeader.css({visibility:"hidden"})})}},
													e.prototype.setupHdrCells=function(){
														var b=this;b.$hdrCells.each(function(c){
															var d=a(this),
															e=d.prop("id"),
															f=d.text();
															if(e||(e=b.idPrefix+c,d.prop("id",e)),""===f&&(f=d.attr("data-col-name")),
																d.is("[data-priority]")){
